...
selector_params = {"Иностранные языки": {"key_words": ["англ", "немец", "франц", "итал", " нем"], "all_words": False},
                    "Изобразительное искусство": {"key_words": ["изобр", "иск", "изо"], "all_words": True},
                    "Информатика": {"key_words": ["информатик"], "all_words": True},
                    "Литература": {"key_words": ["литерат", "чтен"], "exclude_words": {"немец", "нем", "англ", "итал", "цифр", "испан"}, "all_words": False},
                    "Математика": {"key_words": ["алгеб", "матем", "геомет", "счет", "цифр"], "all_words": False},
                    "Музыка": {"key_words": ["музык"], "all_words": True},
                    "Окружающий мир": {"key_words": [" окр", " мир", "природ", "естествознан"], "exclude_words": {"бумажн"}, "all_words": False},
                    "Русский язык": {"key_words": ["родн", "рус", "яз", "пишем", "чистопис", "писат", "азбук", "грамот", "пропис", "письм", "букварь"], "exclude_words": ["литер", "чтен", "немец", "нем", "англ", "итал", "цифр", "испан"], "all_words": False},
                    ...
                    "Биология": {"key_words": ["биолог", "естественнонауч", "естествознан", "природ"], "all_words": False},
                    ...
                    "Общественные науки": {"key_words": ["обществ", "культур", "граждан", "финан", " прав"], "exclude_words": {"физкульт", " обж"},  "all_words": False},
