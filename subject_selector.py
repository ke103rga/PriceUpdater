...
selector_params = {"Иностранные языки": {"key_words": ["англ", "немец", "франц"], "all_words": False},
                    ...
                    "Математика": {"key_words": ["алгеб", "матем", "геомет", "счет"], "all_words": False},
                    "Музыка": {"key_words": ["музык"], "all_words": True},
                    "Окружающий мир": {"key_words": ["окр", "мир", "природ", "естествознан",], "all_words": False},
                    "Русский язык": {"key_words": ["родн", "рус", "яз", "пишем", "чистопис", "писат", "азбук", "грамот", "пропис", "письм", "букварь"], "exclude_words": ["литер", "чтен"], "all_words": False},
